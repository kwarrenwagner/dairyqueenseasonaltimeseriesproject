...
**Table of Contents**
Thank you for reading my executive summary, if you want to read my full time series report, it is linked. I also have my code linked [here](https://github.com/kwarrenwagner/dairyqueenseasonaltimeseriesproject/blob/main/dairyqueensearch.ipynb).
